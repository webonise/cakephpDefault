...
/**
 * models behavior to support generation of slugs for models.
 *
 * @package app
 * @subpackage app.models.behaviors
 */
class SluggableBehavior extends ModelBehavior
{
     ...
     *
     * @param object $Model models using the behaviour
    ...
    function setup(&$Model, $settings = array())
    {
        ...
        //$this->__settings[$models->alias] = am($this->__settings[$models->alias], ife(is_array($settings), $settings, array()));
     ...
     *
     * @param object $Model models about to be saved.
